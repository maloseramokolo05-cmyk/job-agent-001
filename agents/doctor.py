...
from backend.config import ROOT,database_path,load_profile,load_preferences
...
def run_doctor():
 ...
 add("Master CV","PASS" if find_master(ROOT/"cv") else "WARN","loaded" if find_master(ROOT/"cv") else "upload PDF/DOCX in dashboard")
